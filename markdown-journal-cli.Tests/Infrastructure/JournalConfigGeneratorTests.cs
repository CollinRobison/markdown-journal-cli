...
public class JournalConfigGeneratorTests
{
    ...
    public JournalConfigGeneratorTests()
    {
        ...
        _fileTracking = new FileTracking(_fileSystem, Options.Create(_journalSettings), hashService);
        _entryFormatter = new EntryFormatterService(Options.Create(_journalSettings));
        _journalConfiguration = new JournalConfiguration(_fileSystem, Options.Create(_journalSettings), NullLogger<JournalConfiguration>.Instance);
  ...
  ""Files"": {
    ...
    ""personal-journal.md"": {
      ...
      ""LastChecked"": ""2026-01-01T00:00:00Z""
        ...
        var topicNames = config.TableOfContents.Structure.Topics.Select(t => t.Name).OrderBy(n => n).ToArray();
        ...
        var personalTopic = config.TableOfContents.Structure.Topics.First(t => t.Name == "personal");
  ...
  ""Files"": {
    ...
    ""work-meeting.md"": {
      ...
      ""LastChecked"": ""2026-01-01T00:00:00Z""
        ...
        Assert.True(config.TableOfContents.IgnoreFiles == null || config.TableOfContents.IgnoreFiles.Length == 0);
    }
    ...
    public void GenerateFromTableOfContents_EmptyDirectory_ThrowsArgumentException()
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => 
            _generator.GenerateFromTableOfContents("", "toc"));
    }
    ...
    public void GenerateFromTrackingIndex_NullDirectory_ThrowsArgumentException()
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => 
            _generator.GenerateFromTrackingIndex(null!, "toc"));
    }
    ...
    public void GenerateFromDirectory_NullDirectory_ThrowsArgumentException()
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => 
            _generator.GenerateFromDirectory(null!, "toc"));
    }
